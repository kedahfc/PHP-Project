  ...
  <!-- End Header -->
    ...
    <section id="pricing" class="pricing">
      <div class="container">
        ...
        <h1 style=text-align:center;margin-top:-20px>Membership Plan</h1>
        ...
        <div class="col-md-3" style=text-align:center;margin-left:250px>
          <div class="card shadow">
            <div class="card-body">
              ...
              <div class="btn-wrap">
              <a href="register-basic-member.php"class="btn btn-primary"> Choose</a>
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="col-md-3" style=text-align:center;margin-left:40px>
          <div class="card shadow">
            <div class="card-body">
              ...
              <div class="btn-wrap">
              <a href="register-premium-member.php"class="btn btn-primary"> Choose</a>
              </div>
            </div>
          </div>
        </div>
