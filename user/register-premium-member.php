...
if(isset($_POST['submit2']))
{
  ...
  $subcription_period=$_POST['subcription_period'];
  $fee=$_POST['fee'];
  $description=$_POST['description'];

  $sql="INSERT INTO  membership(Subcription_Period,Fee,Description) VALUES(:subcription_period,:fee,:description)";

  $query = $dbh->prepare($sql);
  $query->bindParam(':description',$description,PDO::PARAM_STR);
  $query->bindParam(':fee',$fee,PDO::PARAM_STR);
  $query->bindParam(':subcription_period',$subcription_period,PDO::PARAM_STR);
        ...
        <div class="col-md-4" style=text-align:center;margin-left:40px>
          <div class="card shadow">
            <div class="card-body">
              ...
              <div class="form-group"  style=text-align:center>
              <a href="payment-premium.php"class="btn btn-primary">Pay Now</a>
            </div>
