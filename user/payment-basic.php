          ...
          <div class="card shadow">
            <div class="card-body">
              ...
              <div class="form-group" style=margin-left:-5px>
                    <a href="https://toyyibpay.com/Basic-Membership-Plan" onclick="submit">
                    ...
                    <div class="form-group" style=margin-left:-15px>
                      <button
                        ...
                        id="checkout-button-price_1I8ISdHMpgomrUIsr31GIaEh"
                        role="link"
                        type="button"
                      >
        ...
        <div class="col-md-3" style=text-align:center;margin-left:40px>
          <div class="card shadow">
            <div class="card-body">
              ...
              <label>Membership Plan : </label> Basic
              </div>

              <div class="form-group" style=font-size:15px;color:#000000;text-align:left;margin-top:10px>
              <label>Annual Price : </label> RM 210
              </div>
...
(function() {
  ...
  var checkoutButton = document.getElementById('checkout-button-price_1I8ISdHMpgomrUIsr31GIaEh');
  checkoutButton.addEventListener('click', function () {
    ...
    stripe.redirectToCheckout({
      lineItems: [{price: 'price_1I8ISdHMpgomrUIsr31GIaEh', quantity: 1}],
      mode: 'subscription',
      /*
