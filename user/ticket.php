...
<section id="blog" class="blog">
  <div class="container">
    ...
    <h3 style=text-align:center>Ticket List</h3>
    ...
    <div class="col-md-12">
        <div class="card shadow">
          ...
          <div class="form-group row" style=margin-top:50px;color:#66121a;font-size:20px;background-color:#f3b7bd>
              ...
              <div class="col-sm-8">
              <p><?php echo htmlentities($result->Ticket_Description);?></p>
              </div>
            </div>
            ...
            <div>
              <div> 
                <a href="ticket-details.php?ticketid=<?php echo htmlentities($result->id);?>" class="view"></a>
              </div>
