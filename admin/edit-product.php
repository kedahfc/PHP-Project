...
$sql="update  product set Product_Name=:product_name, Price=:price where id=:productid";
...
<body class="vertical  light">
    <div class="wrapper">
        ...
        <a href="manage-product.php" class="btn btn-primary">Back to Manage Product</a>
        </div>
                    ...
                    <div class="col-12">
                        ...
                        <?php if($_SESSION['updatemsg']!="")
                            ...
                            <div class="col-md-6">
                                ...
                                <strong style=color:#001a4e>Error :</strong> 
                                <?php echo htmlentities($_SESSION['updatemsg']);?>
                                <?php echo htmlentities($_SESSION['updatemsg']="");?>
                                </div>
                            </div>
                            ...
                            <div class="card shadow mb-4">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-8">
                                            <input class="form-control" type="text" name="product_name"  value="<?php echo htmlentities($result->Product_Name);?>" /> 
                                        </div>
                                    </div> 
                                    ...
                                    <div class="form-group row">
                                        <label for="focusedinput" class="col-sm-3 col-form-label">Image</label>
                                        <div class="col-sm-5" style=margin-left:-80px>
                                            <img src="product-images/<?php echo htmlentities($result->Image);?>" width="200">&nbsp;&nbsp;&nbsp;<a href="change-image-product.php?imgid=<?php echo htmlentities($result->id);?>" >Change Image</a>
                                        </div>
                                    </div>
