...
if(isset($_POST['create']))
{
    ...
    $sql="INSERT INTO  results(Match_Name,Match_Team1,Match_Team2,Match_Date,Result1,Result2) VALUES(:match_name,:match_team1,:match_team2,:match_date,:result1,:result2)";
...
$query -> execute();
$_SESSION['delmsg']="Income Category Deleted";
}
?>
                      ...
                      <tbody>
                        ...
                        <tr class="odd gradeX">
                          ...
                          <td>
                            ...
                            <a href="results.php?del=<?php echo htmlentities($result->id);?>" onclick="return confirm('Are you sure you want to delete?');"><i class="fe fe-trash-2" style=color:#e4606d></i>
                          </td>  
                        </tr>
