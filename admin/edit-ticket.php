...
$sql="update  ticket set Match_Name=:match_name, Match_Team1=:match_team1,Match_Team2=:match_team2, Match_Date=:match_date, Match_Time=:match_time, Ticket_Price=:ticket_price, Member_Price=:member_price, Ticket_Availability=:ticket_availability, Ticket_Description=:ticket_description where id=:ticketid";
...
$query->execute();
$_SESSION['updatemsg']="Ticket information updated successfully";
                            ...
                            <div class="card shadow mb-4">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-4">
                                            <input class="form-control" type="text" name="match_name"  value="<?php echo htmlentities($result->Match_Name);?>"/>  
                                        </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-4">
                                            <input class="form-control" type="number" name="ticket_price"  value="<?php echo htmlentities($result->Ticket_Price);?>"/> 
                                        </div>

                                        <label class="col-sm-1.8 col-form-label" style=margin-right:-10px>Member Price</label>      
                                        <div class="col-sm-4">
                                            <input class="form-control" type="number" name="member_price"  value="<?php echo htmlentities($result->Member_Price);?>"/> 
                                        </div>
                                    </div> 

                                    <div class="form-group row">
                                        <label class="col-sm-1.5 col-form-label" style=margin-right:10px>Availablity</label>      
                                        <div class="col-sm-4">
                                            <input class="form-control" type="number" name="ticket_availability" value="<?php echo htmlentities($result->Ticket_Availability);?>"/> 
                                        </div>
                                    </div>  
                                    ...
                                    <div class="form-group row">
                                        <label class="col-sm-1.8 col-form-label">Description</label>
                                            <div class="col-sm-10">
                                                <textarea type="textarea" name="ticket_description"  placeholder="Enter Description" class="form-control"><?php echo htmlentities($result->Ticket_Description);?></textarea>
                                            </div>
                                    </div>
