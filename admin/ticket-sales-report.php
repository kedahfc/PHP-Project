    ...
    <div class="wrapper">
          ...
          <!-- End Sidebar -->
            ...
            <main role="main" class="main-content">
                ...
                <tr class="form-group">  
                <a href="income-report.php" class="btn btn-primary">Back to Other Income Report</a>
                </tr>

                    <div class="row justify-content-center">
                        <div class="col-10">
                            <h2 class="page-title" style=margin-top:40px>Ticket Sales Report</h2>

                            <form method="post" name="bwdatesreport" action="ticket-sales-report-details.php">
