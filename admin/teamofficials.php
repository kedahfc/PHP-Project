...
header('location:index.php');
  ...
  if(isset($_POST['create']))
  {
    ...
    $sql="INSERT INTO  team_officials(Position,Official_Name) VALUES(:position,:official_name)";
  ...
  if($lastInsertId)
  {
  $_SESSION['msg']="Team Officials' information listed successfully";
...
{
$id=$_GET['del'];
$sql = "delete from team_officials WHERE id=:id";
$query = $dbh->prepare($sql);
  ...
  <div class="wrapper">
    ...
    <main role="main" class="main-content">
      <div class="container-fluid">
        ...
        <a href="seniorofficials.php" class="btn btn-primary">Back to Senior Officials</a>
        </div>


        <div class="row justify-content-center">
          <div class="col-12" style=margin-top:20px>
            <h2 class="page-title">Add Team Officials</h2>
            ...
            <form role="form" method="post">
              ...
              <div class="card shadow mb-4">
                <div class="card-header">
                    <strong class="card-title">Team Officials Details</strong>
                </div>
          ...
          <div class="col-12" style=margin-top:20px>
            <h2 class="mb-2 page-title">Manage Team Officials</h2>
          </div>
              ...
              <div class="card-body">
                ...
                <table class="table datatables" id="dataTable-1">
                  ...
                  <tbody>
                    ...
                    <?php 
                        $sql = "SELECT * from  team_officials";
                        $query = $dbh -> prepare($sql);
                        $query->execute();
                    ...
                    <tr class="odd gradeX">
                      ...
                      <td>
                        <a href="edit-teamofficials.php?teamid=<?php echo htmlentities($result->id);?>"><i class="fe fe-edit" style=color:#64dbb3></i>
                        <a href="teamofficials.php?del=<?php echo htmlentities($result->id);?>" onclick="return confirm('Are you sure you want to delete?');"><i class="fe fe-trash-2" style=color:#e4606d></i>
                      </td>
                    </tr>
