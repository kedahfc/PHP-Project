...
if(isset($_POST['create']))
{
    ...
    $sql="INSERT INTO  matches(Match_Name,Match_Team1,Match_Team2,Match_Date,Match_Time,Fixtures_Description) VALUES(:match_name,:match_team1,:match_team2,:match_date,:match_time,:fixtures_description)";
            ...
            <div class="container-fluid">
                ...
                <div class="row justify-content-center">
                            ...
                            <div class="card shadow mb-4">
                                ...
                                <div class="card-body">
                                    ...
                                    <label class="col-sm-1.8 col-form-label">Match Date</label>
                                        ...
                                        <label class="col-sm-1.8 col-form-label" style=margin-left:42px>Match Time</label>
                                    ...
                                    <div class="form-group row">
                                        <label class="col-sm-1.8 col-form-label">Description</label>
                                            <div class="col-sm-10" style=margin-left:5px>
                                                <textarea type="textarea" name="fixtures_description"  placeholder="Enter Description" class="form-control"></textarea>
                                            </div>
                                    </div>
                    ...
                    <div class="col-12" style=margin-top:20px>
                        <h2 class="mb-2 page-title">Manage Match</h2>
                    </div>
                                ...
                                <table class="table datatables" id="dataTable-1">
                                    ...
                                    <tbody>
                                        ...
                                        <td><?php echo htmlentities($cnt);?></td>
											...
											<td style=text-align:left><?php echo htmlentities($result->Fixtures_Description);?></td>
                                            <td>
                                            <a href="edit-match.php?matchid=<?php echo htmlentities($result->id);?>"><i class="fe fe-edit" style=color:#64dbb3></i>
                                            <a href="matches.php?del=<?php echo htmlentities($result->id);?>" onclick="return confirm('Are you sure you want to delete?');"><i class="fe fe-trash-2" style=color:#e4606d></i>
                                        </td>
                                        </tr>
