...
$sql="update news set News_Image2=:nimage2 where id=:imgid";
            ...
            <?php if($error)
              ...
              <?php } 
                ...
                <form class="form-horizontal" name="news" method="post" enctype="multipart/form-data">
								...
								<?php 
								$imgid=intval($_GET['imgid']);
								$sql = "SELECT News_Image2 from news where id=:imgid";
								$query = $dbh -> prepare($sql);
								$query -> bindParam(':imgid', $imgid, PDO::PARAM_STR);
								$query->execute();
								...
								<div class="col-sm-8">
								<img src="news-images/<?php echo htmlentities($result->News_Image2);?>" width="200">
								</div>
								</div>
