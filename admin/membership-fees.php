        ...
        <main role="main" class="main-content">
            ...
            <a href="income.php" class="btn btn-primary">Back to Other Income</a> 
                ...
                <div class="row justify-content-center">
                    <div class="col-12">
                    <h2 class="mb-4 page-title" style=margin-top:40px>Membership Fees</h2>
                    </div>
                    <!-- Small table -->
                    <div class="col-md-12">
                            ...
                            <div class="card-body">
                                ...
                                <table class="table datatables" id="dataTable-1">
                                    ...
                                    <tbody>
                                        ...
                                        <?php $sql = "SELECT * from membership_fees";
                                        $query = $dbh -> prepare($sql);
                                        $query->execute();
                                        ...
                                        <tr class="odd gradeX">
                                            ...
                                            <td class="center">RM <?php echo htmlentities($result->Amount_Paid);?></td>
