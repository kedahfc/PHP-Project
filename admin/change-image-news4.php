...
$sql="update news set News_Image4=:nimage4 where id=:imgid";
            ...
            <?php if($error)
              ...
              <?php } 
                ...
                <form class="form-horizontal" name="news" method="post" enctype="multipart/form-data">
								...
								<?php 
								$imgid=intval($_GET['imgid']);
								$sql = "SELECT News_Image4 from news where id=:imgid";
								$query = $dbh -> prepare($sql);
								$query -> bindParam(':imgid', $imgid, PDO::PARAM_STR);
								$query->execute();
								...
								<div class="col-sm-8">
								<img src="news-images/<?php echo htmlentities($result->News_Image4);?>" width="200">
								</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-8">
										<input type="file" name="news_image4" id="news_image4" required>
									</div>
								</div>	
								<?php }} ?>
