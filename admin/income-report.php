...
<body class="vertical  light">
    <div class="wrapper">
          ...
          <!-- End Sidebar -->
            ...
            <tr class="form-group">  
            <a href="fees-report.php" class="btn btn-primary">Membership Fees Report</a>
            <a href="ticket-sales-report.php" class="btn btn-primary">Ticket Sales Report</a> 
            </tr>
                    ...
                    <div class="row justify-content-center">
                        <div class="col-10">
                            ...
                            <form method="post" name="bwdatesreport" action="income-report-details.php">
